# PiRC1: ZYN Ecosystem Token Design (ZynMart Request for Comment)

This document presents the **ZYN Ecosystem Token Design** — an enhanced token launch framework building upon PiRC1 while introducing critical innovations for marketplace-driven ecosystems. ZYN is designed to power the ZynMart marketplace and the broader Pi app ecosystem with immediate utility, merchant alignment, and sustainable tokenomics.

Community feedback is essential. Pioneers, developers, and merchants are encouraged to review, comment, and submit suggestions through GitHub Issues, Discussions, or Pull Requests.
...
- [`4-allocation`](4-allocation/4-allocation.md)
- [`5-tge-state`](5-tge-state.md)
- [`6-merchant-integration`](6-merchant-integration.md)
- [`7-loyalty-rewards`](7-loyalty-rewards.md)
- [`8-cross-app-utility`](8-cross-app-utility.md)
